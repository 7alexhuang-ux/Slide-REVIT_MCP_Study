...
<!-- card -->
### `create_dimension` 被多個 Domain 共用
只需開發一次，就能支援多個 Domain 的視覺化回饋

<!-- card -->
### 排煙檢討
標註窗戶在「天花板下 80cm 有效帶」內的實際開啟高度
...
<!-- card -->
- 前言：上次聽 David 分享居室採光法規檢討，想到自己之前算很久的排煙窗也可以檢討
- 我的目標：盡量透過窗戶排煙，不設置排煙設備，同時盡量不新增窗型

<!-- card -->
### 條件一：所有樓層
`當層樓地板面積 ≥ 1000m²`
且
`當層有效開口面積 > 當層樓地板面積 1/30`

<!-- card -->
### 條件二：單一居室
`居室面積 > 50m²`
且
`天花板下80cm有效通風面積 < 居室面積 2%`
...
<!-- card -->
### 更上層的規定
特定用途場所，`總樓地板面積 ≥ 500m²` 就需要設置排煙設備

<!-- card -->
### 空間更大時
防煙區劃（每 500m² 一個區），依區劃個別檢討
...
<!-- card -->
### AI 給建議
列出「現有窗型還需補幾個才合規」的具體數字

<!-- card -->
### 人做決定
要換窗型？改天花高度？做機械排煙？這個判斷必須是建築師來做
